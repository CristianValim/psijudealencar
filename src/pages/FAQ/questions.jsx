export const questions = [
    ...
    },
    {
      ...
      answer: (
        <>
          <div className="row-start">
            <h1>Quem pode ou deve fazer sessões com uma psicóloga?</h1>
            <p>Indo direto ao ponto: não é “coisa de gente louca” e qualquer pessoa pode fazê-la. Essa associação à loucura se deve muito às origens históricas da psicologia como profissão, principalmente pela forte relação com os tratamentos em hospitais psiquiátricos durante o século passado aqui no Brasil.</p>
            </div>
          <div className="row-end">
            <p className='ident'>Hoje o cenário é muito diferente, mas essa imagem ainda preconcebida ainda permanece em boa parte da população. Ainda hoje se realizam atendimentos a casos bastante delicados (ex: psicoses, transtornos dissociativos, de personalidade, entre outros) em hospitais e clínicas, mas a atuação do psicólogo é muito mais abrangente. Eu coloquei propositalmente “sessões com um psicólogo” porque os atendimentos não se resumem a trabalhar sobre os transtornos psicológicos.</p>
            
            <p className='ident'>Qualquer pessoa pode recorrer a esse atendimento independente de idade, crenças, capacidades cognitivas, tipo de problemas ou situações pelas quais está passando.</p>
          </div>
        </>
      )
    },
