  ...
  return (
    <Container id='contato'>
      <div className="flex-wrapper">
        <img className='logoGreen' src={isMobileLogo ? logoGreen : logoGreenSquare } alt="Logo Juliana de Alencar" /> 
        <Link className="instalogo" to="https://instagram.com/psi.judealencar" target='_blank' rel="noopener noreferrer"><FaInstagram /> <span>@psi.judealencar</span></Link>
        <button><Link to="https://wa.me/5548998468897" target='_blank' rel="noopener noreferrer"><FaWhatsapp className='wpplogo'/>Agende uma sessão</Link></button>
      </div>
